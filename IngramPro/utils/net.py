...
def scrapy_useragent() -> None:
    ...
    for browser in browsers:
        ...
        # Only take the first 100 entries - older entries are outdated browser versions
        for i in items[:100]:  
...
def get_user_agent(name='random') -> str:
    ...
    Data sourced from https://useragentstring.com/pages/useragentstring.php
    Generated by running scrapy_useragent() and pasting the result below.
    """
